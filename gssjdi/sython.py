...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@ieFBI"))
...
async def update(event):
    await event.edit("يتم أعادة تشغيل السورس ... ✅ ")
    await sython.disconnect()
    await sython.send_message("me", "`اكتملت اعادة تشغيل السورس !`")

@sython.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع الاسدي"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@Y1Y2bot', 'جاري التجميع بواسطة | FBI')
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@Y1Y2bot', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@Y1Y2bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@Y1Y2bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await sython.get_messages('@Y1Y2bot', limit=1)
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@LUCITHON"))
    except BaseException:
        pass
...
async def _(event):
      await event.reply("""السـورس يعمـل | @ieFBI
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""SY OWNER : @SaQiier"""
)
